...
const icMetaData = document.querySelector(".ic-metadata")
...
gallery.querySelectorAll(".image-container").forEach(container => {
    ...
    container.addEventListener("click", e => {
        ...
        if (Scroll.elementEndClicked != container) {
            ...
            icMetaData.querySelector("#ic-title").innerText = container.dataset.title;
            icMetaData.querySelector("#ic-mood").innerText = container.dataset.mood;
            icMetaData.querySelector("#ic-time").innerText = container.dataset.time;
            container.appendChild(icMetaData)
