    ...
    */
    ...
    filterButton.addEventListener("click", () => {
        if (rotating) {
            ...
            document.querySelector("#filter-dimmer").classList.remove("hidden")
        } else {
            rotateBorderColors();
            rotating = true;
            galleryScroll.negative.style.zIndex = "";
            document.querySelector("header").style.paddingBottom = "";
            document.querySelector("#filter-dimmer").classList.add("hidden")
        }
    ...
    */
    ...
    document.querySelectorAll("#filter-output > section > div").forEach(output => {
        output.addEventListener("click", e => {
            selectOutputOption(output)
        })
    })
    ...
    document.querySelector("#filter-reset-buttons").addEventListener("click", e => {
        // idk why i did this
